    ...
    <>
      ...
      <div className="about-page">
        <div className="about-wrap">
          <section className="about-hero about-section">
            ...
            <div className="hero-card">
              <div className="hero-card-head">
                ...
                <p className="hint">Curated by real incidents across payments stacks.</p>
              </div>
          ...
          <section className="about-how about-section">
          ...
          <section className="about-examples about-section">
            <div className="section-header">
              <p className="eyebrow">Sample incidents</p>
              <h2>Real-world test cases baked in</h2>
              <p className="lede">
                Try the built-in cases to see how the assistant responds to card declines, ACH
                returns, JDE timeouts, and DEA/license issues.
              </p>
            </div>

            <div className="example-track" role="list">
          ...
          <section className="about-tech about-section">
            <div className="section-header">
          ...
          <section className="about-footer-card about-section">
            <div>
